...
export function IconUsers() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
      ...
      <path d="M15.8 14c2.9.2 5.2 2.4 5.2 5.6" />
    </svg>
  );
}
...
export function IconBike() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
      ...
      <path d="M6 17l4-8h5l3 5M10 9h4M9 17h9" />
    </svg>
  );
}
...
export function IconPhoneCall() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
      <path d="M4 4h4l2 5-2.5 1.5a12 12 0 0 0 6 6L15 14l5 2v4a2 2 0 0 1-2.2 2C9.4 21.5 2.5 14.6 2 6.2A2 2 0 0 1 4 4Z" />
    </svg>
  );
}
